...
data_import;
 ...
 state_name = 'Missouri'; %input('Please enter state name ', 's');
 ...
 %%
 opening_date_1 = 'May 25 2020';% input('Please enter opening date ', 's');
...
opening_date_2 = 'July 22 2020';% input('Please enter opening date ', 's');
...
opening_date_3 = 'September 25 2020';
...
opening_date_4 = 'November 24 2020';%
...
% First scenario
scale = 1.2;  % we increase the transmisssion rate since school opening 
model_forecast; 
x_scale_1 = x_6;
