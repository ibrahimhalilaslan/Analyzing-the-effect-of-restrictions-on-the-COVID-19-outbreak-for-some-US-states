 ...
 for i = 1:length(temp_x_31)-1
  ...
  for j = 1: length(data_i1)-1
     ...
     data_i2(j+1) = data_i1(j+1)-data_i1(j);
      ...
      hold on
      plot(tvec, plot_vector_2(:, 7), 'LineWidth',3, 'color', '[0.0, 0.5, 0.0]')
      hold on
      plot(tvec, plot_vector_3(:, 7), 'LineWidth',3, 'color', '[0.55, 0.71, 0.0]')
      hold on
     ...
     legend('50% decrease in Social Distancing','No change in Social Distancing','50% increase in Social Distancing' ,'Data' ,'FontSize',13, 'Location','northwest')
     legend boxoff
      ...
      hold on
      plot(tvec, plot_vector_2(:, 8),  'LineWidth',3, 'color', '[0.0, 0.5, 0.0]')
      hold on
      plot(tvec, plot_vector_3(:, 8),  'LineWidth',3, 'color', '[0.55, 0.71, 0.0]')
      hold on
