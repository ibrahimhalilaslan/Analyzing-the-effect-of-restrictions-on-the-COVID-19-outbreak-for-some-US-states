...
data_import;
 ...
 state_name = 'Illinois'; %input('Please enter state name ', 's');
 ...
 %%
 opening_date_1 = 'May 10 2020';% input('Please enter opening date ', 's');
...
opening_date_2 = 'June 20 2020';% input('Please enter opening date ', 's');
...
opening_date_4 = 'November 13 2020';%
