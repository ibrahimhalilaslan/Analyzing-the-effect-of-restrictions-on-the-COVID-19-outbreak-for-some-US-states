...
% Set the time 
 ...
 timeperiod_impulse = length(data_i_after_opening_date_4);
...
beta =  ModelParamaters4(1, 1);
r =  ModelParamaters4(1, 2);
mu_q = ModelParamaters4(1, 3);
i_q =  ModelParamaters4(1, 4);
gamma_q = ModelParamaters4(1, 5);
mu_i = ModelParamaters4(1, 6);
