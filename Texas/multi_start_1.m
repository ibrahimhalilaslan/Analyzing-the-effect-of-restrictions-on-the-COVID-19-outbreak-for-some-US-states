...
%Set the parameters 
%LowerBounds = [s_q_l  beta_l   r_l        i_q_l        q_s_l    mu_q_l   gamma_q_l];
%UpperBounds = [s_q_u  beta_u   r_u        i_q_u        q_s_u    mu_q_u   gamma_q_u];

LowerBounds = [0.01,      0.5,    0.05,       0.2,          1,       0.0001     0.08];
UpperBounds = [0.2,         4,      0.5,        0.28,         2.5,      0.02       0.1];
