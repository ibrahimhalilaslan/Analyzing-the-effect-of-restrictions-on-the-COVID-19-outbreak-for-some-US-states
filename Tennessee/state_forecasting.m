...
data_import;
 ...
 state_name = 'Tennessee'; %input('Please enter state name ', 's');
...
opening_date_2 = 'June 27 2020';% input('Please enter opening date ', 's');
...
opening_date_4 = 'January 14 2021';%
